...
const tableExample = [
  {
    avatar: { src: 'https://un.logo.com', status: 'success' },
    user: {
  ...
  {
    avatar: { src: 'https://un.logo.com', status: 'danger' },
    user: {
      name: 'Avram Tarasios',
      new: false,
      registered: 'Jan 1, 2023',
  ...
  {
    avatar: { src: 'https://un.logo.com', status: 'warning' },
  ...
  {
    avatar: { src: 'https://un.logo.com', status: 'secondary' },
